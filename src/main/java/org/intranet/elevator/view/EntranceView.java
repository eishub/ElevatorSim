...
public class EntranceView extends JComponent {
	 ...
	 * 
	 * @param entrance
	 *            the {@link CarEntrance} (the model)
	 * @param width
	 *            the entire width including buttons
	 * @param height
	 *            the entire height including buttons.
	 */
	...
	public void paintComponent(Graphics g) {
		...
		g.fillRect(marginX + entranceWidth - doorWidth, marginY, doorWidth,
				entranceHeight);
