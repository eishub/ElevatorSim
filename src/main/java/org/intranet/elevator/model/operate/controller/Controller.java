...
public interface Controller {
	/**
	 * called when controller is initialized, just before it is inserted into
	 * the {@link org.intranet.elevator.model.operate.Building}.
	 * 
	 * @param eQ
	 *            the event queue that the Controller works on.
	 */
	 ...
	 * 
	 * @param newFloor
	 *            is the pickup floor of the person
	 * @param d
	 *            is the direction that the person wants to travel in
	 */
	 ...
	 * 
	 * @param car
	 *            is the car to be inserted
	 * @param stoppingDistance
	 *            UNKNOWN what this is but usually 3.0
	 */
	void addCar(Car car, float stoppingDistance);

	/**
	 * To be called only once when a car arrives at a location. This is done by
	 * the {@link org.intranet.elevator.model.operate.Building}. Allows the
	...
	/**
	 * Called by the {@link org.intranet.elevator.model.operate.Building} when
	 * the door was closed. Gives the controller the hint that it is time to set
	 * a target floor.
	 * 
	 * @param car
	 *            is the car that has closed doors now.
	 */
